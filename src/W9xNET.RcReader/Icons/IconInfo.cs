...
namespace W9xNET.RcReader.Icons
{
    ...
    public class IconInfo
    {
        ...
        /// <summary>
        /// Gets the W9xNET.RcReader.IconDir of the icon.
        /// </summary>
        ...
        /// <summary>
        /// Gets the W9xNET.RcReader.GroupIconDir of the icon.
        /// </summary>
        ...
        /// <summary>
        /// Gets a list of W9xNET.RcReader.IconDirEntry of the icon.
        /// </summary>
        ...
        /// <summary>
        /// Gets a list of W9xNET.RcReader.GroupIconDirEntry of the icon.
        /// </summary>
        ...
        #region Constructors
        /// <summary>
        /// Intializes a new instance of W9xNET.RcReader.IconInfo which contains the information about the givin icon.
        /// </summary>
        ...
        /// <summary>
        /// Intializes a new instance of W9xNET.RcReader.IconInfo which contains the information about the icon in the givin file.
        /// </summary>
        ...
        public int GetBestFitIconIndex()
        {
            ...
            try { iconIndex = Interop.Win32.User32.LookupIconIdFromDirectory(resBits, true); }
        ...
        {
            int iconIndex = 0;
            var flags = Interop.Win32.User32.LookupIconIdFromDirectoryExFlags.LR_DEFAULTCOLOR;
            if (isMonochrome)
                flags = Interop.Win32.User32.LookupIconIdFromDirectoryExFlags.LR_MONOCHROME;
            IntPtr resBits = Marshal.AllocHGlobal(this.ResourceRawData.Length);
            Marshal.Copy(this.ResourceRawData, 0, resBits, this.ResourceRawData.Length);
            try { iconIndex = Interop.Win32.User32.LookupIconIdFromDirectoryEx(resBits, true, desiredSize.Width, desiredSize.Height, flags); }
            finally { Marshal.FreeHGlobal(resBits); }
