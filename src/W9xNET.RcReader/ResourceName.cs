...
namespace W9xNET.RcReader
{
    ...
    public class ResourceName : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new W9xNET.RcReader.ResourceName object.
        /// </summary>
        ...
        public ResourceName(IntPtr lpName)
        {
            ...
            {
                this.Id = null;
                this.Name = Marshal.PtrToStringAuto(lpName) ?? string.Empty;
            }
        }
        ...
        /// <summary>
        /// Returns a System.String that represents the current W9xNET.RcReader.ResourceName.
        /// </summary>
        /// <returns>Returns a System.String that represents the current W9xNET.RcReader.ResourceName.</returns>
